...
static constexpr unsigned int PSR_USR	    = 0b10000;
static constexpr unsigned int PSR_IRQ	    = 0b10010;
static constexpr unsigned int PSR_SYS	    = 0b11111;
static constexpr unsigned int PSR_MODE_MASK = 0b11111;
